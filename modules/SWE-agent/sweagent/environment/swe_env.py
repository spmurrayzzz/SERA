...
class EnvironmentConfig(BaseModel):
    ...
    deployment: DeploymentConfig = Field(
        default_factory=lambda: DockerDeploymentConfig(image="python:3.11", python_standalone_dir="/root", startup_timeout=1200),
...
class SWEEnv:
    ...
    def communicate(
        ...
        *,
        check: Literal["warn", "ignore", "raise", "raise_no_close"] = "ignore",
